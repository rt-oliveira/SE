...
void Volei::Jogo(int comando,LedControl lc) {
  switch (comando) {
    case 0x30CF:
      pontoMaisTime1(lc);
      break;
...
void Volei::pontoMaisTime1(LedControl lc) {
  pontos1++;
...
void Volei::pontoMaisTime2(LedControl lc) {
  pontos2++;
...
void Volei::pontoMenosTime1(LedControl lc) {
  if (pontos1 >= 1) {
    pontos1--;
    lc.setDigit(0, 0, pontos1 / 10, false);
    lc.setDigit(0, 1, pontos1 % 10, false);
...
void Volei::pontoMenosTime2(LedControl lc) {
  if (pontos2 >= 1) {
    pontos2--;
    lc.setDigit(0, 2, pontos2 / 10, false);
    lc.setDigit(0, 3, pontos2 % 10, false);
